...
{
      	kal_uint32 retry = 0;
	// Convert from : #2_S5K4H7YX_1632x1224_2BIN_30fps_MCLK_24M_p280M_mipi700.sset
...
{		
	...
	// Convert from : #1_S5K4H7YX_Full_3264x2448_30fps_MCLK_24M_p280M_mipi700.sset
...
static void hs_video_setting(void)
{
	...
	//VGA 120fps
	// Convert from : #4_S5K4H7YX_640x480_4BIN_120fps_MCLK_24M_p280M_mipi700.sset
	write_cmos_sensor_8(0x0100,0x00);
	# if 1	
		while(retry<100)
		{
...
static void slim_video_setting(void)
{
	...
	// mode setting
	// Convert from : #3_S5K4H7YX_1280x720_2BIN_30fps_MCLK_24M_p280M_mipi700.sset
	write_cmos_sensor_8(0X0100, 0X00);
	# if 1	
		while(retry<100)
		{
...
//	LOG_2;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			printk("s5k4h7yxmipiraw_Sensor_sunwin open sensor_id = %x\r\n",sensor_id);
			if (sensor_id == imgsensor_info.sensor_id) {
