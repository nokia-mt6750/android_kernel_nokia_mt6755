...
#include "s5k4h7yxstmipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "s5k4h7yxst_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YXST_SENSOR_ID,
...
{
      	kal_uint32 retry = 0;
	// Convert from : #2_S5K4H7YXST_1632x1224_2BIN_30fps_MCLK_24M_p280M_mipi700.sset
...
{		
	...
	// Convert from : #1_S5K4H7YXST_Full_3264x2448_30fps_MCLK_24M_p280M_mipi700.sset
...
static void hs_video_setting(void)
{
	...
	//VGA 120fps
	// Convert from : #4_S5K4H7YXST_640x480_4BIN_120fps_MCLK_24M_p280M_mipi700.sset
	write_cmos_sensor_8(0x0100,0x00);
	# if 1	
		while(retry<100)
		{
...
static void slim_video_setting(void)
{
	...
	// mode setting
	// Convert from : #3_S5K4H7YXST_1280x720_2BIN_30fps_MCLK_24M_p280M_mipi700.sset
	write_cmos_sensor_8(0X0100, 0X00);
	# if 1	
		while(retry<100)
		{
...
//	LOG_2;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			sensor_id += 2;
			printk("s5k4h7yxstmipiraw_Sensor_sunwin open sensor_id = %x\r\n",sensor_id);
			if (sensor_id == imgsensor_info.sensor_id) {
...
UINT32 S5K4H7YXST_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
